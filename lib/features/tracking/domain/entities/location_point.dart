...
/// Punto de ubicación GPS con lógica matemática incluida
class LocationPoint extends Equatable {
  ...
  /// Calcula la distancia precisa en metros entre dos coordenadas considerando la curvatura de la Tierra
...
/// Clase auxiliar para gestionar la ruta completa
class Route {
  ...
  double get estimatedCalories => distanceKm * 60; // Estimación simple
}
